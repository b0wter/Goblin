...
var $author$project$Main$ResetNewMixedCard = function (a) {
	return {$: 'ResetNewMixedCard', a: a};
};
...
var $author$project$Main$Instructions = {$: 'Instructions'};
	...
	function (flags, url, key) {
		...
		var _v3 = A2(
			...
			url,
			{
				...
				modelNewMixedCardVisibility: $rundis$elm_bootstrap$Bootstrap$Modal$hidden,
				multiDice: $author$project$DiceModel$withName('Roll multiple dice'),
				navKey: key,
				navState: navState,
				newMixedCard: $author$project$MixedCard$firstEmptyCard,
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						urlCmd,
						navCmd,
						A2($elm$random$Random$generate, $author$project$Main$ResetNewMixedCard, $TSFoster$elm_uuid$UUID$generator)
					])));
	});
var $author$project$Main$MixedCardDropStateChange = function (a) {
	return {$: 'MixedCardDropStateChange', a: a};
};
			...
			A2(
				...
				function (x) {
					return A2(
						...
						function (z) {
							return $author$project$Main$MixedCardDropStateChange(
								_Utils_Tuple2(x.id, z));
						});
				},
				model.mixedCards)));
};
var $author$project$Main$NewMixedCardResult = function (a) {
	return {$: 'NewMixedCardResult', a: a};
};
...
var $author$project$Main$saveMixedCardsToLocalStorage = function (model) {
	return $author$project$Main$StoreData(
		A2(
			...
			$author$project$MixedCard$encodeMultiple(model.mixedCards)));
};
...
var $author$project$Main$addNewSet = function (model) {
	...
	var modelWithNewSet = function () {
		if (isComplete) {
			var addedSet = A2($author$project$Main$addMixedSet, model.newMixedCard, model);
			return _Utils_update(
				addedSet,
				{modelNewMixedCardVisibility: $rundis$elm_bootstrap$Bootstrap$Modal$hidden});
		} else {
	...
	var additionalCommand = isComplete ? A2($elm$random$Random$generate, $author$project$Main$ResetNewMixedCard, $TSFoster$elm_uuid$UUID$generator) : $elm$core$Platform$Cmd$none;
			...
			switch (msg.$) {
				...
				case 'ResetNewMixedCard':
					...
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none);
				case 'ShowMixedSetModal':
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{modelNewMixedCardVisibility: $rundis$elm_bootstrap$Bootstrap$Modal$shown}),
						$elm$core$Platform$Cmd$none);
				case 'ClearNewSet':
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$RollMixedCard = function (a) {
	return {$: 'RollMixedCard', a: a};
};
var $author$project$Main$SetMixedCardExplode = function (a) {
	return {$: 'SetMixedCardExplode', a: a};
};
...
var $author$project$Main$MixedCardNewValue = function (a) {
	return {$: 'MixedCardNewValue', a: a};
};
...
var $author$project$Main$mixedRollMaxElementsDropDown = function (card) {
	return A4(
		...
		function (x) {
			return $author$project$Main$MixedCardNewValue(
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Main$RollMixedCard(
							...
							[
								...
								_List_fromArray(
									[
										...
										card.dice.explodes,
										function (b) {
											return $author$project$Main$SetMixedCardExplode(
									...
									[
										...
										_List_fromArray(
											[
												...
												$rundis$elm_bootstrap$Bootstrap$Button$small,
												$rundis$elm_bootstrap$Bootstrap$Button$onClick(
												$author$project$Main$ClearMixedCardResults(card.id))
											]),
										_List_fromArray(
											[
		...
		[
			...
			_List_fromArray(
				[
					...
					$rundis$elm_bootstrap$Bootstrap$Grid$col,
					_List_fromArray(
						[$rundis$elm_bootstrap$Bootstrap$Grid$Col$xs12, $rundis$elm_bootstrap$Bootstrap$Grid$Col$sm6, $rundis$elm_bootstrap$Bootstrap$Grid$Col$md6, $rundis$elm_bootstrap$Bootstrap$Grid$Col$lg4]),
					_List_fromArray(
						[
					...
					$rundis$elm_bootstrap$Bootstrap$Grid$col,
					_List_fromArray(
						[$rundis$elm_bootstrap$Bootstrap$Grid$Col$xs12, $rundis$elm_bootstrap$Bootstrap$Grid$Col$sm6, $rundis$elm_bootstrap$Bootstrap$Grid$Col$md6, $rundis$elm_bootstrap$Bootstrap$Grid$Col$lg8]),
					_List_fromArray(
						[
...
var $author$project$Main$pageInstructions = function (_v0) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$p,
...
var $author$project$Main$mainContent = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('large-top-margin')
			]),
		_List_fromArray(
			[
				A2(
				...
				function () {
					...
					switch (_v0.$) {
						...
						case 'Instructions':
							return $author$project$Main$pageInstructions(model);
						case 'Modules':
...
var $author$project$Main$ShowMixedSetModal = {$: 'ShowMixedSetModal'};
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Create mixed set')
						])),
					A2(
					$rundis$elm_bootstrap$Bootstrap$Navbar$itemLink,
					_List_fromArray(
...
var $author$project$Main$newDiceSetList = function (model) {
	...
	return (!$elm$core$List$length(model.newMixedCard.dieFaces)) ? A2(
		$elm$html$Html$div,
		_List_fromArray(
			[$rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$mb1, $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$mt1]),
		_List_fromArray(
			[
				$elm$html$Html$text('Add dice using the buttons above.')
			])) : A2(
		$elm$html$Html$div,
		_List_Nil,
		A2($elm$core$List$indexedMap, dieButton, model.newMixedCard.dieFaces));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								$rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.newMixedCard.name),
...
var $author$project$Main$modal = function (model) {
	return A2(
		...
		model.modelNewMixedCardVisibility,
		A3(
			$rundis$elm_bootstrap$Bootstrap$Modal$body,
			_List_Nil,
			_List_fromArray(
			...
			A3(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Create custom set')
					]),
