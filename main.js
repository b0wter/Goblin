...
var $author$project$Main$diceCard = function (model) {
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$diceResultMsg(model)
									]))
							])))
				]),
			A3(
				...
				A3(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Roll single die')
						]),
...
var $author$project$Main$multiDiceCard = function (model) {
	return $rundis$elm_bootstrap$Bootstrap$Card$view(
		A3(
			...
			_List_fromArray(
				[
					$rundis$elm_bootstrap$Bootstrap$Card$Block$custom($author$project$Main$multiDiceTable),
					$rundis$elm_bootstrap$Bootstrap$Card$Block$custom(
					A2(
						$rundis$elm_bootstrap$Bootstrap$Grid$row,
						_List_Nil,
			...
			A3(
				...
				A3(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Roll multiple dice')
						]),
					$rundis$elm_bootstrap$Bootstrap$Card$config(
						_List_fromArray(
							[
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Main$diceCard(model)
						])),
					A2(
					$rundis$elm_bootstrap$Bootstrap$Grid$col,
					_List_fromArray(
